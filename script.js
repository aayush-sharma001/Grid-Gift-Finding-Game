...
function makeGrid(){
    ...
    while(count != noOfGifts){
        ...
        if(count<noOfGifts-1 && btns[index].querySelector("img").getAttribute("alt")==""){
            btns[index].querySelector("img").setAttribute("src","../image/gift.png");
            ...
            btns[index].querySelector("img").setAttribute("src","../image/sign.png");
    ...
    btns.forEach((btn)=>{
        if(btn.querySelector("img").getAttribute("alt")==""){
            btn.querySelector("img").setAttribute("src","../image/cancel.png");
